  ...
  return (
    <Container>
        ...
        <Wrapper>
            ...
            <Line></Line> */}
            <Div3>
                <H1 data-aos="fade-down" style={{color: "#012C6D"}}>Investment plans that suits your personality</H1>
                ...
                <Box data-aos="fade-down">
                    <FaMoneyBill style={{color: "#2671D4", width: "30px", height: "30px"}}/>
                    <Butn>Forex</Butn>
                </Box>
                <Box data-aos="fade-down">
                <FaChartBar style={{color: "#2671D4", width: "30px", height: "30px"}}/>
                    <Butn>Stocks</Butn>
                </Box>
                <Box data-aos="fade-down">
                <FaCoins style={{color: "#2671D4", width: "30px", height: "30px"}}/>
                    <Butn>Crypto</Butn>
                </Box>
                <Box data-aos="fade-down">
                <FaMoneyBill style={{color: "#2671D4", width: "30px", height: "30px"}}/>
                    <Butn style={{width: "110px"}}>Non-Farm Payroll</Butn>
                </Box>
                <Box data-aos="fade-down">
                <FaMoneyBill style={{color: "#2671D4", width: "30px", height: "30px"}}/>
                    <Butn style={{width: "110px"}}>Non-renewable energy</Butn>
                </Box>
                </BoxHold>
                <Butn style={{marginTop: "30px", width: "150px", padding:"10px 8px", fontSize: "14px"}}>More Products</Butn>
            </Div3>
        </Wrapper>
        </Holder>
    </Container>
